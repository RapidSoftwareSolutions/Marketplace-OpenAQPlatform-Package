...
$app->post('/api/OpenAQPlatform/getMeasurementsData', function ($request, $response) {
    ...
    $requiredParams = [];
    $optionalParams = ['city'=>'city','country'=>'country','location'=>'location','parameter'=>'parameter','hasGeo'=>'hasGeo','coordinates'=>'coordinates','radius'=>'radius','valueFrom'=>'valueFrom','valueTo'=>'valueTo','dateFrom'=>'date_from','dateTo'=>'date_to','orderBy'=>'order_by','sort'=>'sort','limit'=>'limit','page'=>'page'];
    $bodyParams = [
